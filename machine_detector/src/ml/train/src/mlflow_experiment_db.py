...
from machine_detector.configurations import FeatureConfigurations
...
try:
    ...
    X_train, y_train = train.drop(FeatureConfigurations.TARGET, axis=1), train[FeatureConfigurations.TARGET]
