...
from src.experiments.utils import get_or_create_experiment, champion_callback
...
experiment_id = get_or_create_experiment("Logistic-Experiment")
...
def objective(trial, X, y, cv, scoring):
    ...
    model = make_pipeline(
        pipe.input_pipeline, LogisticRegression(**params, random_state=42)
    )
...
with mlflow.start_run(experiment_id=experiment_id, run_name=args.run_name, nested=True):
